...
class NegativeSideLengthError(Exception):
    """Исключение, возникающее при попытке создать прямоугольник со сторонами отрицательной длины."""
    pass
        ...
        with open(filename, 'r') as csvfile:
            ...
            for row in reader:
                ...
                if a <= 0 or b <= 0 or c <= 0:
                    raise NegativeSideLengthError("Одно или несколько значений сторон прямоугольника отрицательные.")
                roots = func(a, b, c)
...
# Запуск функции нахождения корней квадратного уравнения с заданными параметрами
